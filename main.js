let averageGrade = parseFloat(prompt("Insira a média desejada (se nada for inserido, o valor padrão será 7):"));
...
form.addEventListener("submit", (e) => {
    ...
    function createNewTableRow() {
        ...
        document.querySelectorAll("table th").forEach(column => tds.push(document.createElement("td")));
    ...
    function updateTableFooter() {
        const [, totalAverageTd, approvalStatusTd] = document.querySelectorAll("tfoot tr td");
        ...
        if (calculateTotalAverage() >= averageGrade) {
            ...
            span.classList.contains("reprovado") && span.classList.remove("reprovado");
...
// TODO: Mandar pra um repositório remoto do GitHub
// TODO: Fazer deploy no Vercel